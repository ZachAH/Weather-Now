...
function searchWeather(searchButton) {
    fetch("http://api.openweathermap.org/data/2.5/weather?q=" + searchButton + "&appid=d91f911bcf2c0f925fb6535547a5ddc9&units=imperial")
    ...
    .then(function(data) {
      ...
      getForecast(searchButton);
      
    }
  )}

  function getForecast(searchButton) {
    fetch("http://api.openweathermap.org/data/2.5/forecast?q=" + searchButton + "&appid=d91f911bcf2c0f925fb6535547a5ddc9&units=imperial")
    .then(function(response){
  ...
  document.querySelector("#search-button").addEventListener("click", setSearchButton);
